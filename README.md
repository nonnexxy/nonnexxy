...
For **5+ years**, I've been deep-diving into server setups, configs, and Discord infrastructure. I enjoy fixing broken systems and improving how everything runs `behind the scenes`.
...
* 📊 **Data** — *MySQL & complex data configs*
* 🤖 **Discord** — *Automation, bots, and clean hierarchy*
